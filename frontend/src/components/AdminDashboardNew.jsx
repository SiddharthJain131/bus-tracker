          ...
          <TabsContent value="overview" className="space-y-6">
            ...
            <Card className="p-6">
              ...
              <div className="flex items-center gap-6">
                <div className="w-20 h-20 bg-gradient-to-br from-violet-400 to-purple-600 rounded-full flex items-center justify-center text-white text-3xl font-bold overflow-hidden transition-all duration-300 hover:scale-110 hover:shadow-xl hover:ring-4 hover:ring-violet-300 cursor-pointer">
                  {user.photo ? (
