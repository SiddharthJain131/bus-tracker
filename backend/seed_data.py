...
async def seed_data():
    ...
    users = [
        # ADMINS
        {
            ...
            "name": "James Anderson",
            "phone": "+1-555-9001",
            "photo": f"/api/photos/admins/{admin1_id}.jpg",
        ...
        },
        {
            ...
            "phone": "+1-555-9002",
            "photo": f"/api/photos/admins/{admin2_id}.jpg",
        ...
        # TEACHERS
        {
            ...
            "name": "Mary Johnson",
            "phone": "+1-555-2001",
            "photo": f"/api/photos/teachers/{teacher1_id}.jpg",
        ...
        },
        {
            ...
            "name": "Robert Smith",
            "phone": "+1-555-2002",
            "photo": f"/api/photos/teachers/{teacher2_id}.jpg",
        ...
        },
        {
            ...
            "name": "Sarah Wilson",
            "phone": "+1-555-2003",
            "photo": f"/api/photos/teachers/{teacher3_id}.jpg",
        ...
        # PARENTS (12 parents for 20 students - demonstrating Many:1 relationship)
        {
            ...
            "name": "John Parent",
            "phone": "+1-555-3001",
            "photo": f"/api/photos/parents/{parent_ids[0]}.jpg",
        ...
        },
        {
            ...
            "name": "Sarah Brown",
            "phone": "+1-555-3002",
            "photo": f"/api/photos/parents/{parent_ids[1]}.jpg",
        ...
        },
        {
            ...
            "name": "Michael Davis",
            "phone": "+1-555-3003",
            "photo": f"/api/photos/parents/{parent_ids[2]}.jpg",
        ...
        },
        {
            ...
            "name": "Emily Martinez",
            "phone": "+1-555-3004",
            "photo": f"/api/photos/parents/{parent_ids[3]}.jpg",
        ...
        },
        {
            ...
            "name": "David Wilson",
            "phone": "+1-555-3005",
            "photo": f"/api/photos/parents/{parent_ids[4]}.jpg",
        ...
        },
        {
            ...
            "phone": "+1-555-3006",
            "photo": f"/api/photos/parents/{parent_ids[5]}.jpg",
        ...
        },
        {
            ...
            "phone": "+1-555-3007",
            "photo": f"/api/photos/parents/{parent_ids[6]}.jpg",
        ...
        },
        {
            ...
            "phone": "+1-555-3008",
            "photo": f"/api/photos/parents/{parent_ids[7]}.jpg",
        ...
        },
        {
            ...
            "name": "Matthew Lee",
            "phone": "+1-555-3009",
            "photo": f"/api/photos/parents/{parent_ids[8]}.jpg",
        ...
        },
        {
            ...
            "name": "Jessica Harris",
            "phone": "+1-555-3010",
            "photo": f"/api/photos/parents/{parent_ids[9]}.jpg",
        ...
        },
        {
            ...
            "name": "Daniel Clark",
            "phone": "+1-555-3011",
            "photo": f"/api/photos/parents/{parent_ids[10]}.jpg",
        ...
        },
        {
            ...
            "name": "Lisa Lewis",
            "phone": "+1-555-3012",
            "photo": f"/api/photos/parents/{parent_ids[11]}.jpg",
