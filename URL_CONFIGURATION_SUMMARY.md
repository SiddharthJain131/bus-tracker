...
DB_NAME="bus_tracker"
BACKEND_BASE_URL="https://unused-cleanup.preview.emergentagent.com"  # External backend URL
CORS_ORIGINS="*"  # Allowed CORS origins (comma-separated)
```

### Frontend Configuration (`/app/frontend/.env`)
```bash
REACT_APP_BACKEND_URL=https://unused-cleanup.preview.emergentagent.com  # Backend API endpoint
WDS_SOCKET_PORT=443
...
- ✅ Kept production URL: `https://unused-cleanup.preview.emergentagent.com`
